...
const APP_RELEASE={version:'6.3.0',buildId:'v6.3.0-20260728-firebase-authentication'};
...
async function diagnosticsPage(){
  ...
  const urls=['/index.html','/assets/js/app.js?v=6.3.0','/assets/js/map-explorer.js?v=6.3.0','/data/trip.json','/data/build-info.json','/diagnostics.html'];
