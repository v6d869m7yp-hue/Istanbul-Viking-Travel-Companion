...
const APP_RELEASE={version:'6.4.2',buildId:'v6.4.2-20260728-map-marker-tap-fix'};
...
async function diagnosticsPage(){
  ...
  const urls=['/index.html','/assets/js/app.js?v=6.4.0','/assets/js/map-explorer.js?v=6.4.0','/data/trip.json','/data/build-info.json','/diagnostics.html'];
